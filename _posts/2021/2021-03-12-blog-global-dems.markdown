...
The downloaded tiles are zip files with quite a lot more content than the DEM tiles. You can use the Framework process _UnZipTandemX_ to only explode only the DEM data.
