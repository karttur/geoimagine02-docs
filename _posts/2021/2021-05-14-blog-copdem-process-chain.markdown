...
## json/0001_DEM_CreatesScaling_v090.json

## json/0002_DEM_CreatePalettes_v090.json

###################################
###     Search and download     ###
###################################

## Search for Copernicsus DEM 90 product ##
## json/0100-CopernicusDEM_search-90m.json

## Download Copernicus DEM
## json/0120-CopernicusDEM_download-90m.json
...
## json/CopernicusDEM-0120_unzip-dem90.json

###################################
###          Mosaic Raw         ###
###################################

## json/0118-copernicusDEM-mosaic-raw.json

## json/0118-COPDEM30-mosaic-raw.json
...
## json/0200_tile_CopeDem90-ease2n.json

## json/0200_tile_CopeDem30-ease2n.json

## json/0202_tile_tilemosaicDem90-ease2n.json

## json/0202_tile_tilemosaicDem30-ease2n.json
...
## json/0309_CopDEM_grassfilldem_ease2n.json

## Creare virtual mosaics of the filled DEM
## json/0202_tile_tilemosaicFillDem90-ease2n.json

## Fill larger pits in streams with r.hydrodem
## json/0309_CopDEM_grasshydrodem_ease2n.json

## Creare virtual mosaics of the filled**2 DEM
## json/0202_tile_tilemosaichydroDem90-ease2n.json

###################################
###      Land/water divide      ###
###################################

## json/0310_CopDEM_grass-basins-stage0b_ease2n.json

###################################
###   Calculate DEM derivates   ###
###################################

## json/0310_CopernicusDEM_gdaldemtiles_ease2n.json

## json/0310_CopernicusDEM_gdaldem_ease2n.json

## json/0310_CopernicusDEM_numpydem_ease2n.json
...
## json/0310_CopDEM_grassdem3+9_ease2n.json

## run r.watershed and r.stream.XXX for individual tiles (stage 1)

## json/0310_CopDEM_r-watershed_ease2n.json

## run basin mouth extract and shorewall fixing

json/0310_CopDEM_grass-basins-stage2_ease2n.json

## After 0310_CopDEM_grass-basins-stage2_ease2n run the basin outlet
## json/0315_CopDEM_Basin-outlets-tiles_ease2n.json
...
## json/CopernicusDEM_0210_mosaic_ease2n.json

###################################
###        Export tiles         ###
###################################

## json/0905_DEM-elevation_ExportTilesToByte_v090.json

## json/0905_DEM-elevation_ExportShadeTilesToByte_v090.json
...
To produce symbolised and labeled map using the Framework, you have to define some _Layout_ features and parameters. All map layout is done using byte range maps with values rangng from 1 to 255, Where values 251 to 255 are reserved for specific purposes and not allowed for representing map values. To produce a symbolised map using the Framework you need to define the _scaling_ and the _palette_.
...
Scaling is not defined on the fly, instead each map composition (see the post on ??? for an explanation on the Framework map composition concept) must be associated with a predefined scaling. Once defined, this scaling can not be changed.
